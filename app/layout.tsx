    ...
    <html lang="ko">
      <body className="min-h-screen">
        <div className="flex min-h-screen">
          {/* 사이드바 */}
          <aside className="w-64 shrink-0 border-r border-ink-700 bg-ink-900/80 backdrop-blur">
            ...
            <div className="absolute bottom-0 w-64 p-4 border-t border-ink-700 bg-ink-900/80">
              ...
              <div className="text-[10px] text-ink-400 mt-2 num-mono">v0.4.2 · 2026.05.14</div>
            </div>
          </aside>
